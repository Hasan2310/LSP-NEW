...
@section('content')
    <div class="max-w-4xl mx-auto mt-10 bg-white p-8 rounded-lg shadow-md">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">Edit Maskapai</h2>
        @if ($errors->any())
        ...
        <form action="{{ route('maskapais.update', $maskapai->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <!-- dashboard/maskapai/edit.blade.php -->
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        @if ($maskapai->foto)
                            <div class="mt-2">
                                <img src="{{ Storage::url($maskapai->foto) }}" alt="Foto Maskapai"
                ...
                <div>
                    ...
                    <input type="text" name="nama_maskapai" id="nama_maskapai" value="{{ $maskapai->nama_maskapai }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="kota_keberangkatan" id="kota_keberangkatan"
                        value="{{ $maskapai->kota_keberangkatan }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="kota_tujuan" id="kota_tujuan" value="{{ $maskapai->kota_tujuan }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="tanggal" id="tanggal" value="{{ $maskapai->tanggal }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input type="time" name="jam_berangkat" id="jam_berangkat"
                        value="{{ old('jam_berangkat', \Carbon\Carbon::parse($maskapai->jam_berangkat)->format('H:i')) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input type="time" name="jam_tiba" id="jam_tiba"
                        value="{{ old('jam_tiba', \Carbon\Carbon::parse($maskapai->jam_tiba)->format('H:i')) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="harga_tiket" id="harga_tiket" value="{{ $maskapai->harga_tiket }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="number" name="kapasitas_kursi" id="kapasitas_kursi"
                        value="{{ $maskapai->kapasitas_kursi }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
